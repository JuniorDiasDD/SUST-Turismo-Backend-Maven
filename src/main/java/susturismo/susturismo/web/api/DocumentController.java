...
public class DocumentController implements DocumentApi{
    ...
    @Override
    public ResponseEntity<ResponseDTO<DocumentDTO>> findByID(UUID id, RequestDTO<DocumentDTO> request) {
        ...
        if (document.isPresent()) {
            dto = documentDTOConverter.convertToDTO(document.get());
    ...
    public ResponseEntity<ResponseDTO<DocumentDTO>> insert(RequestDTO<DocumentDTO> request) {
        ...
        DocumentDTO dto= documentDTOConverter.convertToDTO(documentService.findById(document.getId()).get());
    ...
    @Override
    public ResponseEntity<ResponseDTO<DocumentDTO>> edit(RequestDTO<DocumentDTO> request) {
        HttpHeaders headers = new HttpHeaders();
        ResponseDTO<DocumentDTO> response;

        Document document=documentService.edit(documentDTOConverter.convertToEntity(request.getRequest()));
